...
part 'FetchProductsResponse.g.dart';
...
class FetchProductsResponse {
    ...
    factory FetchProductsResponse.fromJson(Map<String, dynamic> json) => _$FetchProductsResponseFromJson(json);

    Map<String, dynamic> toJson() => _$FetchProductsResponseToJson(this);
}
